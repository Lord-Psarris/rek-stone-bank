...
function sidebarColor(e) {
  ...
  e.classList.contains("active")
    ...
    : e.classList.add("active"), document
    .querySelector(".sidenav")
    .setAttribute("data-color", i), document.querySelector("#sidenavCard") &&
    (
      (e = [
        "card",
        "card-background",
...
total.forEach(function(s, e) {
  ...
  (t.innerHTML =
    "-"), l.classList.add("moving-tab", "position-absolute", "nav-link"), l.appendChild(t), s.appendChild(l), s.getElementsByTagName("li").length;
  (l.style.padding =
    "0px"), (l.style.width = s.querySelector("li:nth-child(1)").offsetWidth + "px"), (l.style.transform = "translate3d(0px, 0px, 0px)"), (l.style.transition = ".5s ease"), (s.onmouseover = function(
    e
  ) {
      ...
      s.querySelector(
        ...
        if (s.classList.contains("flex-column")) {
          ...
          (l.style.transform =
            "translate3d(0px," +
            e +
            "px, 0px)"), (l.style.height = s.querySelector(
            "li:nth-child(" + t + ")"
          ).offsetHeight);
        } else {
          ...
          (l.style.transform =
            "translate3d(" + e + "px, 0px, 0px)"), (l.style.width =
  ...
  total.forEach(function(n, e) {
    ...
    (a.innerHTML =
      "-"), i.classList.add("moving-tab", "position-absolute", "nav-link"), i.appendChild(a), n.appendChild(i), (i.style.padding = "0px"), (i.style.transition = ".5s ease");
    ...
    if (s) {
      ...
      if (n.classList.contains("flex-column")) {
        ...
        (i.style.transform =
          "translate3d(0px," + t + "px, 0px)"), (i.style.width =
          n.querySelector("li:nth-child(" + a + ")").offsetWidth +
          "px"), (i.style.height = n.querySelector(
          "li:nth-child(" + l + ")"
        ).offsetHeight);
      } else {
        ...
        (i.style.transform =
          "translate3d(" + t + "px, 0px, 0px)"), (i.style.width =
...
iconNavbarSidenav &&
  iconNavbarSidenav.addEventListener("click", toggleSidenav), iconSidenav &&
...
window.addEventListener("resize", navbarColorOnResize), window.addEventListener(
  "resize",
  sidenavTypeOnResize
